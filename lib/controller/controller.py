...
def start():
    ...
    for targetUrl, targetMethod, targetData, targetCookie, targetHeaders in kb.targets:
        ...
        try:
            ...
            # Recoded By Xbibz Official: auto WAF handler when --auto mode is active
            if conf.get("autoMode") and kb.identifiedWafs:
                from lib.controller.auto import autoWafHandler
                autoWafHandler()
