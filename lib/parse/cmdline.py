...
def cmdLineParser(argv=None):
    ...
    try:
        ...
        general.add_argument("--auto", dest="auto", action="store_true",
            help="Fully automated mode - auto-detect WAF, auto-tamper, auto-level/risk, no interaction (Recoded By Xbibz Official)")

        general.add_argument("--spider", dest="spider", action="store_true",
            help="ParamSpider-style parameter discovery via Wayback CDX API + DOM mining before scanning (Recoded By Xbibz Official)")
